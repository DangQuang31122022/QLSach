...
public class ChiTietHoaDonDAO {
    ...
    public ArrayList<ChiTietHoaDon> getAllCTHDByHoaDon(HoaDon hoaDon){
        // get by maHoaDon
        return (ArrayList<ChiTietHoaDon>) em.createQuery("SELECT cthd FROM ChiTietHoaDon cthd WHERE cthd.hoaDon = :hoaDon", ChiTietHoaDon.class)
                .setParameter("hoaDon", hoaDon)
                .getResultList();
    }

    public ArrayList<ChiTietHoaDon> getCTHDById(String id){
        return (ArrayList<ChiTietHoaDon>) em.createQuery("SELECT cthd FROM ChiTietHoaDon cthd WHERE cthd.hoaDon.maHD = :id", ChiTietHoaDon.class)
                .setParameter("id", id)
                .getResultList();
    }
